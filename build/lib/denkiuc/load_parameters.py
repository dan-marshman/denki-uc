...
def create_sets(self):
    def assess_category(category):
        path_to_tech_categories_file = os.path.join(self.module_path, 'technology_categories.csv') 
...
def load_initial_state(self):
    initial_state_path = os.path.join(self.inputs_path, 'initial_state.csv')
